...
void selection_relay::init()
{
    ...
    connect(&g_netlist_relay, &netlist_relay::gate_event, this, &selection_relay::handle_gate_event);
    connect(&g_netlist_relay, &netlist_relay::net_event, this, &selection_relay::handle_net_event);
    connect(&g_netlist_relay, &netlist_relay::module_event, this, &selection_relay::handle_module_event);
}
...
void selection_relay::reset()
{
    ...
    // INIT + RESET
    // TODO DECIDE
    disconnect(&g_netlist_relay, &netlist_relay::gate_event, this, &selection_relay::handle_gate_event);
    disconnect(&g_netlist_relay, &netlist_relay::net_event, this, &selection_relay::handle_net_event);
    disconnect(&g_netlist_relay, &netlist_relay::module_event, this, &selection_relay::handle_module_event);
...
void selection_relay::handle_gate_event(gate_event_handler::event ev, std::shared_ptr<gate> object, u32 associated_data)
{
    ...
    case gate_event_handler::event::removed:
    {
        m_size_of_selected_gates--;
        u32* new_array = new u32[m_size_of_selected_gates];
        ...
        for (u32 i = 0; i < m_number_of_selected_gates; i++)
        {
            ...
            {
                if (m_selected_gates[i] != object->get_id())
...
void selection_relay::handle_net_event(net_event_handler::event ev, std::shared_ptr<net> object, u32 associated_data)
{
    Q_UNUSED(associated_data)
    ...
    case net_event_handler::event::removed:
    {
        ...
        for (u32 i = 0; i < m_number_of_selected_nets; i++)
        {
            ...
            {
                if (m_selected_nets[i] != object->get_id())
...
void selection_relay::handle_module_event(module_event_handler::event ev, std::shared_ptr<module> object, u32 associated_data)
{
    Q_UNUSED(associated_data)
    ...
    case module_event_handler::event::removed:
    {
        ...
        for (u32 i = 0; i < m_number_of_selected_modules; i++)
        {
            ...
            {
                if (m_selected_modules[i] != object->get_id())
...
// TODO GET CORE GUARANTEES
// UNCERTAIN ABOUT UNROUTED (GLOBAL) NETS, TODO DECIDE
