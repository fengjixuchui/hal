...
standard_graph_layouter_v2::standard_graph_layouter_v2(graph_context* context, QObject* parent) : graph_layouter(context, parent)
{

}

void standard_graph_layouter_v2::reset()
{
    m_gates.clear();
    m_nets.clear();
    m_gate_levels.clear();
...
//bool standard_cone_layouter_v2::contains_gate(const u32 gate) const
//{
//    return m_gates.contains(gate);
//}

//bool standard_cone_layouter_v2::contains_net(const u32 net) const
//{
...
//void standard_cone_layouter_v2::expand_to_dst(const u32 net, const u32 gate)
//{
...
//void standard_cone_layouter_v2::expand_to_src(const u32 gate, const u32 net)
//{
//    // POSSIBLY DEPRECATED, DONT USE
//    Q_UNUSED(gate)
//    Q_UNUSED(net)
...
void standard_graph_layouter_v2::calculate_max_junction_spacing()
{
    for (const junction* j : m_junctions)
    {
        // LEFT
...
void standard_graph_layouter_v2::calculate_channel_spacing()
{
...
{
    for (const standard_graph_layouter_v2::road* r : m_h_roads)
        delete r;
    m_h_roads.clear();

    for (const standard_graph_layouter_v2::road* r : m_v_roads)
        delete r;
    m_v_roads.clear();
...
standard_graph_layouter_v2::gate_box standard_graph_layouter_v2::make_box(const u32 gate, const int x, const int y) const
{
    gate_box box;
    box.id = gate;
...
{
    // VERIFIED
    for (const standard_graph_layouter_v2::gate_box& box : m_boxes)
        if (box.x == x && box.y == y)
            return true;
...
bool standard_graph_layouter_v2::h_road_jump_possible(const standard_graph_layouter_v2::road* const r1, const standard_graph_layouter_v2::road* const r2) const
{
    // VERIFIED
    if (!(r1 && r2))
        return false;
...
bool standard_graph_layouter_v2::v_road_jump_possible(const standard_graph_layouter_v2::road* const r1, const standard_graph_layouter_v2::road* const r2) const
{
    // VERIFIED
    if (!(r1 && r2))
        return false;
...
standard_graph_layouter_v2::road* standard_graph_layouter_v2::get_h_road(const int x, const int y)
{
    for (standard_graph_layouter_v2::road* r : m_h_roads)
        if (r->x == x && r->y == y)
            return r;

    standard_graph_layouter_v2::road* new_r = new road(x, y);
    m_h_roads.append(new_r);
    return new_r;
}

standard_graph_layouter_v2::road* standard_graph_layouter_v2::get_v_road(const int x, const int y)
{
    for (standard_graph_layouter_v2::road* r : m_v_roads)
        if (r->x == x && r->y == y)
            return r;
...
qreal standard_graph_layouter_v2::left_lane_change_x_for(const int channel_x, unsigned int lane_change) const
{
    // VERIFIED
...
qreal standard_graph_layouter_v2::left_lane_change_x_for(const junction* const j) const
{
    // CONVENIENCE METHOD
...
qreal standard_graph_layouter_v2::right_lane_change_x_for(const int channel_x, unsigned int lane_change) const
{
    // VERIFIED
    // LANE CHANGES COUNTED FROM 0
...
qreal standard_graph_layouter_v2::right_lane_change_x_for(const junction* const j) const
{
    // CONVENIENCE METHOD
...
qreal standard_graph_layouter_v2::top_lane_change_y_for(const int channel_y, unsigned int lane_change) const
{
    // VERIFIED
    // LANE CHANGES COUNTED FROM 0
...
qreal standard_graph_layouter_v2::top_lane_change_y_for(const junction* const j) const
{
    // CONVENIENCE METHOD
...
qreal standard_graph_layouter_v2::bottom_lane_change_y_for(const int channel_y, unsigned int lane_change) const
{
    // VERIFIED
    // LANE CHANGES COUNTED FROM 0
...
qreal standard_graph_layouter_v2::bottom_lane_change_y_for(const junction* const j) const
{
    // CONVENIENCE METHOD
