...
placeholder_layouter::placeholder_layouter(graph_context* context, QObject* parent) : graph_layouter(context, parent)
{
    init_settings();
}

void placeholder_layouter::layout()
{
...
void placeholder_layouter::reset()
{
...
void placeholder_layouter::add(const QSet<u32> gates, const QSet<u32> nets)
{
    Q_UNUSED(gates)
    Q_UNUSED(nets)
}

void placeholder_layouter::remove(const QSet<u32> gates, const QSet<u32> nets)
{
    Q_UNUSED(gates)
    Q_UNUSED(nets)
}

void placeholder_layouter::expand(const u32 from_gate, const u32 via_net, const u32 to_gate)
{
    Q_UNUSED(from_gate)
    Q_UNUSED(via_net)
    Q_UNUSED(to_gate)
...
const QString placeholder_layouter::name() const
{
    return "Placeholer";
}

const QString placeholder_layouter::description() const
{
    return "Placeholder";
}

void placeholder_layouter::generate_gui_gates()
{
    for (std::shared_ptr<gate> g : g_netlist->get_gates())
    {
        graphics_gate* new_gate = new advanced_graphics_gate(g);
...
void placeholder_layouter::compute_gate_levels()
{
...
void placeholder_layouter::apply_gate_layout()
{
...
void placeholder_layouter::squarify_entire_design()
{
...
void placeholder_layouter::compress_gate_levels()
{
    int current_level = 0;
...
void placeholder_layouter::compute_cw_and_scc()
{
    int input_i  = 0;
    int output_i = 0;
    int output_m = 0;
...
void placeholder_layouter::draw_nets()
{
...
void placeholder_layouter::draw_input_net(std::shared_ptr<net> n)
{
...
void placeholder_layouter::draw_output_net(std::shared_ptr<net> n)
{
    global_graphics_net* gui_net = new global_graphics_net(n);
...
void placeholder_layouter::draw_separated_net(std::shared_ptr<net> n, QString text)
{
...
void placeholder_layouter::init_settings()
{
