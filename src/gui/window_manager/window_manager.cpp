    ...
    m_main_settings_widget(new main_settings_widget())
{
    ...
    // THIS WORKS, TODO COMPARE TO HARDCODED EVENT LISTENER
...
void window_manager::set_main_window(hal_window* window)
{
    ...
    // TODO REMOVE CORRECT ACTIONS

    // MAYBE BETTER TO JUST HAVE 1 TOOLBAR, LESS WORK TO MANAGE

    // TODO CHANGE TOOLBAR CONTENT DEPENDING ON APPLICATION STATE
    // TODO ADD FANCY ANIMATION
    // TODO WRITE OWN TOOLBAR CLASS BECAUSE QT CLASS SUCKS
